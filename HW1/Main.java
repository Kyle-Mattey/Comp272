...
public class Main {
    public static void main(String[] args) {
        ...
        MatteyHW1.LinkedList list1 = new MatteyHW1.LinkedList();
        ...
        MatteyHW1.LinkedList list2 = new MatteyHW1.LinkedList();
        ...
        if ( ! MatteyHW1.Stacks.isPalindrome("Was it a car or a cat I saw")) {
            System.out.println("ERROR 8: ispalindrome test failed");
            errorFlag = true;
        }

        if ( ! MatteyHW1.Stacks.isPalindrome("Race Car")) {
            System.out.println("ERROR 9: ispalindrome test failed");
            errorFlag = true;
        }

        if ( ! MatteyHW1.Stacks.isPalindrome("Never odd or even")) {
            System.out.println("ERROR 10: ispalindrome test failed");
            errorFlag = true;
        }

        if ( MatteyHW1.Stacks.isPalindrome("civic2")) {
        ...
        if ( MatteyHW1.Stacks.findLargestK(myStack, 1) != 4) {
            System.out.println("ERROR 12: findLargestk test failed");
            errorFlag = true;
        }

        if ( MatteyHW1.Stacks.findLargestK(myStack, 5) != 0) {
            System.out.println("ERROR 13: findLargestk test failed");
            errorFlag = true;
        }

        if ( MatteyHW1.Stacks.findLargestK(myStack, 4) != 3) {
